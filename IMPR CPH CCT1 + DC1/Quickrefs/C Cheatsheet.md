...
1. [[#Getting Started|Getting Started]]
	...
	3. [[#Getting Started#Constants|Constants]]
	4. [[#Getting Started#Comment|Comment]]
	5. [[#Getting Started#Print text|Print text]]
	6. [[#Getting Started#Control the number of spaces|Control the number of spaces]]
	7. [[#Getting Started#Strings|Strings]]
	8. [[#Getting Started#Condition {.row-span-2}|Condition {.row-span-2}]]
	9. [[#Getting Started#Ternary operator {.col-span-2}|Ternary operator {.col-span-2}]]
	10. [[#Getting Started#Switch|Switch]]
	11. [[#Getting Started#While Loop|While Loop]]
	12. [[#Getting Started#Do/While Loop|Do/While Loop]]
	13. [[#Getting Started#For Loop|For Loop]]
	14. [[#Getting Started#Break out of the loop Break/Continue {.row-span-2}|Break out of the loop Break/Continue {.row-span-2}]]
	15. [[#Getting Started#While Break Example|While Break Example]]
	16. [[#Getting Started#While continue example|While continue example]]
	17. [[#Getting Started#Arrays {.row-span-2}|Arrays {.row-span-2}]]
	18. [[#Getting Started#Enumeration Enum {.col-span-2}|Enumeration Enum {.col-span-2}]]
	19. [[#Getting Started#Enumerate sample applications|Enumerate sample applications]]
	20. [[#Getting Started#User input|User input]]
	21. [[#Getting Started#User input string|User input string]]
	22. [[#Getting Started#memory address|memory address]]
	23. [[#Getting Started#create pointer|create pointer]]
	24. [[#Getting Started#pointer variable {.col-span-2}|pointer variable {.col-span-2}]]
	25. [[#Getting Started#Dereference|Dereference]]
2. [[#Operators|Operators]]
	1. [[#Operators#Arithmetic Operators|Arithmetic Operators]]
	2. [[#Operators#Assignment operator|Assignment operator]]
	3. [[#Operators#Comparison Operators|Comparison Operators]]
	4. [[#Operators#Logical Operators {.col-span-2}|Logical Operators {.col-span-2}]]
	5. [[#Operators#Operator Examples {.row-span-2}|Operator Examples {.row-span-2}]]
	6. [[#Operators#Bitwise operators {.col-span-2}|Bitwise operators {.col-span-2}]]
3. [[#Data Types|Data Types]]
	1. [[#Data Types#Basic data types {.col-span-2}|Basic data types {.col-span-2}]]
	2. [[#Data Types#Data types|Data types]]
	3. [[#Data Types#Basic format specifiers|Basic format specifiers]]
	4. [[#Data Types#Separate base format specifiers|Separate base format specifiers]]
	5. [[#Data Types#Data format example|Data format example]]
4. [[#C Preprocessor|C Preprocessor]]
	1. [[#C Preprocessor#Preprocessor Directives {.row-span-2}|Preprocessor Directives {.row-span-2}]]
	2. [[#C Preprocessor#Predefined macros {.row-span-2}|Predefined macros {.row-span-2}]]
		1. [[#Predefined macros {.row-span-2}#Predefined macro example|Predefined macro example]]
	3. [[#C Preprocessor#Macro continuation operator (\\)|Macro continuation operator (\\)]]
	4. [[#C Preprocessor#String Constantization Operator (#)|String Constantization Operator (#)]]
	5. [[#C Preprocessor#tag paste operator (##)|tag paste operator (##)]]
	6. [[#C Preprocessor#defined() operator|defined() operator]]
	7. [[#C Preprocessor#Parameterized macros|Parameterized macros]]
5. [[#C Function|C Function]]
	1. [[#C Function#Function declaration and definition {.row-span-2}|Function declaration and definition {.row-span-2}]]
	2. [[#C Function#Call function|Call function]]
	3. [[#C Function#Function parameters|Function parameters]]
	4. [[#C Function#Multiple parameters|Multiple parameters]]
	5. [[#C Function#Return value {.row-span-2}|Return value {.row-span-2}]]
	6. [[#C Function#Recursive example|Recursive example]]
	7. [[#C Function#Mathematical functions|Mathematical functions]]
6. [[#C Structures|C Structures]]
	1. [[#C Structures#Create structure|Create structure]]
	2. [[#C Structures#Strings in the structure|Strings in the structure]]
	3. [[#C Structures#Accessing structure members {.row-span-2}|Accessing structure members {.row-span-2}]]
	4. [[#C Structures#Copy structure|Copy structure]]
	5. [[#C Structures#Modify value|Modify value]]
7. [[#File Processing|File Processing]]
	1. [[#File Processing#File processing function|File processing function]]
	2. [[#File Processing#Open mode parameter|Open mode parameter]]
	3. [[#File Processing#Open the file: fopen()|Open the file: fopen()]]
	4. [[#File Processing#Write to file: fprintf()|Write to file: fprintf()]]
	5. [[#File Processing#Read the file: fscanf()|Read the file: fscanf()]]
	6. [[#File Processing#Write to file: fputc()|Write to file: fputc()]]
	7. [[#File Processing#Read the file: fgetc()|Read the file: fgetc()]]
	8. [[#File Processing#Write to file: fputs()|Write to file: fputs()]]
	9. [[#File Processing#Read files: fgets()|Read files: fgets()]]
	10. [[#File Processing#fseek()|fseek()]]
	11. [[#File Processing#rewind()|rewind()]]
	12. [[#File Processing#ftell()|ftell()]]
